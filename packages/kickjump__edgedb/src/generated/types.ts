...
export interface CreatedType extends std.$Object {
  "createdAt": Date;
}
export interface CreatedUpdatedType extends CreatedType {
  "updatedAt": Date;
}
export interface Account extends CreatedUpdatedType {
  "accountType": string;
  "provider": string;
...
export interface Email extends CreatedType {
  "user": User;
  "email": string;
  "primary": boolean;
  "verified": boolean;
}
export interface User extends CreatedUpdatedType {
  "accounts": Account[];
  "email"?: Email | null;
  "emails": Email[];
}
