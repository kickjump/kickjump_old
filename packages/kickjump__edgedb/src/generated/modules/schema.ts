...
const Cardinality: $Cardinality = $.makeType<$Cardinality>(_.spec, "1a725d82-d54d-11ec-aec3-cb1196c5cfb2", _.syntax.literal);
...
const OperatorKind: $OperatorKind = $.makeType<$OperatorKind>(_.spec, "1a740704-d54d-11ec-a509-4d4f1976ba63", _.syntax.literal);
...
const ParameterKind: $ParameterKind = $.makeType<$ParameterKind>(_.spec, "1a75b374-d54d-11ec-a594-b31cb9c64803", _.syntax.literal);
...
const TargetDeleteAction: $TargetDeleteAction = $.makeType<$TargetDeleteAction>(_.spec, "1a7332b6-d54d-11ec-a8fa-c920b81db74e", _.syntax.literal);
...
const TypeModifier: $TypeModifier = $.makeType<$TypeModifier>(_.spec, "1a7689b6-d54d-11ec-b23e-2ff63cbc508a", _.syntax.literal);
...
const Volatility: $Volatility = $.makeType<$Volatility>(_.spec, "1a74e674-d54d-11ec-bf5d-cf0b872cfe59", _.syntax.literal);

export type $Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape = $.typeutil.flatten<_std.$BaseObjectλShape & {
...
type $Object_1a77a9b8d54d11ec8a0a1d99e5153a62 = $.ObjectType<"schema::Object", $Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape, null>;
const $Object_1a77a9b8d54d11ec8a0a1d99e5153a62 = $.makeType<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62>(_.spec, "1a77a9b8-d54d-11ec-8a0a-1d99e5153a62", _.syntax.literal);

const Object_1a77a9b8d54d11ec8a0a1d99e5153a62: $.$expr_PathNode<$.TypeSet<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_1a77a9b8d54d11ec8a0a1d99e5153a62, $.Cardinality.Many), null, true);

export type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
...
const $AnnotationSubject = $.makeType<$AnnotationSubject>(_.spec, "1bd0c5ec-d54d-11ec-84f0-cbb4d017fb8c", _.syntax.literal);
...
const $Alias = $.makeType<$Alias>(_.spec, "1da5793a-d54d-11ec-a1b9-e17d19cc72b5", _.syntax.literal);
...
export type $SubclassableObjectλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
...
const $SubclassableObject = $.makeType<$SubclassableObject>(_.spec, "1a848412-d54d-11ec-9640-37e79b33d837", _.syntax.literal);
...
const $InheritingObject = $.makeType<$InheritingObject>(_.spec, "1bec13c4-d54d-11ec-ae49-19873634d025", _.syntax.literal);
...
export type $AnnotationλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & $InheritingObjectλShape & {
...
const $Annotation = $.makeType<$Annotation>(_.spec, "1bbd2384-d54d-11ec-9f19-53bac97cfe68", _.syntax.literal);
...
export type $TypeλShape = $.typeutil.flatten<$SubclassableObjectλShape & $AnnotationSubjectλShape & {
  ...
  "<__type__[is std::Object]": $.LinkDesc<_std.$Object_19e8423cd54d11ecade577dcb20c1c3e, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is schema::Object]": $.LinkDesc<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62, $.Cardinality.Many, {}, false, false,  false, false>;
  ...
  "<__type__[is CreatedUpdatedType]": $.LinkDesc<_default.$CreatedUpdatedType, $.Cardinality.Many, {}, false, false,  false, false>;
...
const $Type = $.makeType<$Type>(_.spec, "1a986ba8-d54d-11ec-93f2-a530aaf3477b", _.syntax.literal);
...
const $PrimitiveType = $.makeType<$PrimitiveType>(_.spec, "1b0528ec-d54d-11ec-a648-97d5043aa025", _.syntax.literal);
...
const $CollectionType = $.makeType<$CollectionType>(_.spec, "1b244998-d54d-11ec-b7f4-eb06e21b53f3", _.syntax.literal);
...
const $Array = $.makeType<$Array>(_.spec, "1b444ea0-d54d-11ec-b1ab-5b64f1a717fd", _.syntax.literal);
...
const $CallableObject = $.makeType<$CallableObject>(_.spec, "1c31c6d0-d54d-11ec-9f21-edb185c4cdb4", _.syntax.literal);
...
export type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
...
const $VolatilitySubject = $.makeType<$VolatilitySubject>(_.spec, "1c61d172-d54d-11ec-9841-31556cf4cabe", _.syntax.literal);
...
const $Cast = $.makeType<$Cast>(_.spec, "20056ba4-d54d-11ec-86f2-03c3934fccf0", _.syntax.literal);

const Cast: $.$expr_PathNode<$.TypeSet<$Cast, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Cast, $.Cardinality.Many), null, true);

export type $ConsistencySubjectλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
const $ConsistencySubject = $.makeType<$ConsistencySubject>(_.spec, "1cef452a-d54d-11ec-83be-c5f654c68e2a", _.syntax.literal);
...
const $Constraint = $.makeType<$Constraint>(_.spec, "1c78c990-d54d-11ec-afa6-75bd0ed250c6", _.syntax.literal);
...
export type $DeltaλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
...
const $Delta = $.makeType<$Delta>(_.spec, "1ba6613a-d54d-11ec-9d69-714e5cd366d0", _.syntax.literal);
...
export type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
...
const $Extension = $.makeType<$Extension>(_.spec, "206963de-d54d-11ec-af33-a777c9de0556", _.syntax.literal);
...
const $Function = $.makeType<$Function>(_.spec, "1f96145c-d54d-11ec-9268-354960e9dede", _.syntax.literal);
...
const $Index = $.makeType<$Index>(_.spec, "1d13f294-d54d-11ec-8bf6-e3470af6f652", _.syntax.literal);
...
const $Pointer = $.makeType<$Pointer>(_.spec, "1d509078-d54d-11ec-a251-c93e4edc951e", _.syntax.literal);
...
export type $SourceλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
...
const $Source = $.makeType<$Source>(_.spec, "1d337c22-d54d-11ec-8ef3-b1542ce821ab", _.syntax.literal);
...
const $Link = $.makeType<$Link>(_.spec, "1e97b100-d54d-11ec-a901-a9b8ca35aab7", _.syntax.literal);

const Link: $.$expr_PathNode<$.TypeSet<$Link, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Link, $.Cardinality.Many), null, true);

export type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
...
const $Migration = $.makeType<$Migration>(_.spec, "203e3f24-d54d-11ec-9580-e11beaf97a18", _.syntax.literal);
...
export type $ModuleλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & $AnnotationSubjectλShape & {
}>;
type $Module = $.ObjectType<"schema::Module", $ModuleλShape, null>;
const $Module = $.makeType<$Module>(_.spec, "1af3b31e-d54d-11ec-a819-937c981d8eaa", _.syntax.literal);
...
const $ObjectType = $.makeType<$ObjectType>(_.spec, "1e23f2ce-d54d-11ec-9a47-416395b2ba9b", _.syntax.literal);
...
const $Operator = $.makeType<$Operator>(_.spec, "1fcc08aa-d54d-11ec-b313-29448a00effb", _.syntax.literal);
...
export type $ParameterλShape = $.typeutil.flatten<$Object_1a77a9b8d54d11ec8a0a1d99e5153a62λShape & {
  "type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
...
const $Parameter = $.makeType<$Parameter>(_.spec, "1c128f4a-d54d-11ec-a7fd-1fe84c6a2176", _.syntax.literal);
...
const $Property = $.makeType<$Property>(_.spec, "1efeb4f4-d54d-11ec-87f5-e979baa63e44", _.syntax.literal);
...
const $PseudoType = $.makeType<$PseudoType>(_.spec, "1aad06a8-d54d-11ec-94f0-e5a66796bc1f", _.syntax.literal);
...
const $ScalarType = $.makeType<$ScalarType>(_.spec, "1dceb8ea-d54d-11ec-9bf0-41142b93a11b", _.syntax.literal);
...
const $Tuple = $.makeType<$Tuple>(_.spec, "1b7c9602-d54d-11ec-94a3-bb76f7c20579", _.syntax.literal);
...
const $TupleElement = $.makeType<$TupleElement>(_.spec, "1b6b5e6e-d54d-11ec-87f4-4f552a58510b", _.syntax.literal);
...
type __defaultExports = {
  ...
  "Object": typeof Object_1a77a9b8d54d11ec8a0a1d99e5153a62;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_1a77a9b8d54d11ec8a0a1d99e5153a62,
