...
const $anyscalar: $anyscalar = $.makeType<$anyscalar>(_.spec, "12954d0e-d54d-11ec-8497-6f4e46ce745a", _.syntax.literal);

type $anyreal = $anyint | $anyfloat | $anynumeric;
const $anyreal: $anyreal = $.makeType<$anyreal>(_.spec, "129af524-d54d-11ec-8214-97abd80c1ce4", _.syntax.literal);

type $anyfloat = $number;
const $anyfloat: $anyfloat = $.makeType<$anyfloat>(_.spec, "129e936e-d54d-11ec-891d-9fe41c6d08da", _.syntax.literal);

type $anyint = $number | $bigint;
const $anyint: $anyint = $.makeType<$anyint>(_.spec, "129bb78e-d54d-11ec-b812-eb1af5b600dc", _.syntax.literal);

type $anynumeric = $decimal | $bigint;
const $anynumeric: $anynumeric = $.makeType<$anynumeric>(_.spec, "12a0da0c-d54d-11ec-bd8d-eb6e219a2a52", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "12a31de4-d54d-11ec-bc79-1f87f692a074", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "19e15cc4-d54d-11ec-9904-3f14821a403a", _.syntax.literal);
...
export type $Object_19e8423cd54d11ecade577dcb20c1c3eλShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_19e8423cd54d11ecade577dcb20c1c3e = $.ObjectType<"std::Object", $Object_19e8423cd54d11ecade577dcb20c1c3eλShape, null>;
export type $Object = $Object_19e8423cd54d11ecade577dcb20c1c3e
const $Object_19e8423cd54d11ecade577dcb20c1c3e = $.makeType<$Object_19e8423cd54d11ecade577dcb20c1c3e>(_.spec, "19e8423c-d54d-11ec-ade5-77dcb20c1c3e", _.syntax.literal);

const Object_19e8423cd54d11ecade577dcb20c1c3e: $.$expr_PathNode<$.TypeSet<$Object_19e8423cd54d11ecade577dcb20c1c3e, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_19e8423cd54d11ecade577dcb20c1c3e, $.Cardinality.Many), null, true);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "19f07650-d54d-11ec-94f2-1b4ced86d78b", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "129af524-d54d-11ec-8214-97abd80c1ce4", optional: false, setoftype: true, variadic: false}], returnTypeId: "129af524-d54d-11ec-8214-97abd80c1ce4", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "12a3ddf6-d54d-11ec-b379-4d620e9c3a9c", optional: false, setoftype: true, variadic: false}], returnTypeId: "12a3ddf6-d54d-11ec-b379-4d620e9c3a9c", returnTypemod: "OptionalType", preservesOptionality: true},
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "1dceb8ea-d54d-11ec-9bf0-41142b93a11b", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "1dceb8ea-d54d-11ec-9bf0-41142b93a11b", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { $anyscalar, $anyreal, $anyfloat, $anyint, $anynumeric, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_19e8423cd54d11ecade577dcb20c1c3e, Object_19e8423cd54d11ecade577dcb20c1c3e, $FreeObject, FreeObject };
...
type __defaultExports = {
  ...
  "Object": typeof Object_19e8423cd54d11ecade577dcb20c1c3e;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_19e8423cd54d11ecade577dcb20c1c3e,
