...
const AllowBareDDL: $AllowBareDDL = $.makeType<$AllowBareDDL>(_.spec, "222008ea-d54d-11ec-b61b-f5183d1e65a7", _.syntax.literal);
...
const $ConfigObject = $.makeType<$ConfigObject>(_.spec, "21e1c166-d54d-11ec-b9c6-2f9e663cd7cc", _.syntax.literal);
...
const $AbstractConfig = $.makeType<$AbstractConfig>(_.spec, "228195ec-d54d-11ec-8613-658cc91da61e", _.syntax.literal);
...
const $Auth = $.makeType<$Auth>(_.spec, "2221559c-d54d-11ec-a549-f7705b13f937", _.syntax.literal);
...
const $AuthMethod = $.makeType<$AuthMethod>(_.spec, "21f13754-d54d-11ec-b781-c1b746fa31df", _.syntax.literal);
...
const $Config = $.makeType<$Config>(_.spec, "22bb26fe-d54d-11ec-ac9d-f751ca4a2442", _.syntax.literal);
...
const $DatabaseConfig = $.makeType<$DatabaseConfig>(_.spec, "2332ea4a-d54d-11ec-affd-f39350da1f3e", _.syntax.literal);
...
const $InstanceConfig = $.makeType<$InstanceConfig>(_.spec, "22f752be-d54d-11ec-8573-21e06007e069", _.syntax.literal);
...
const $SCRAM = $.makeType<$SCRAM>(_.spec, "220f6684-d54d-11ec-9326-3bd06973e2cb", _.syntax.literal);
...
const $Trust = $.makeType<$Trust>(_.spec, "22005126-d54d-11ec-ac76-39c7f3aeab9d", _.syntax.literal);
