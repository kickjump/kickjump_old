import { Duration, LocalDate, LocalDateTime, LocalTime, RelativeDuration, Range, } from "edgedb";
...
function shapeToEdgeQL(shape, ctx, type = null, keysOnly = false) {
...
function literalToEdgeQL(type, val) {
    ...
    if (typeof val === "string") {
        ...
        const elTypeName = elType.__name__ === "std::number" ? "std::float64" : elType.__name__;
