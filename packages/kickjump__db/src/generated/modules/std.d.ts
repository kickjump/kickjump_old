...
declare type $anyscalar = $uuid | $str | $bytes | $bool | $datetime | _cal.$local_datetime | _cal.$local_date | _cal.$local_time | $duration | $json | _cal.$relative_duration | _cal.$date_duration | _cfg.$memory | $anypoint | $anyreal | $.EnumType;

declare type $anypoint = $anydiscrete | $anycontiguous;

declare type $anydiscrete = $number | _cal.$local_date;

declare type $anycontiguous = $decimal | $datetime | _cal.$local_datetime | $duration | $anyfloat;
...
export declare type $bytes = $.ScalarType<"std::bytes", Buffer>;
...
export declare type $json = $.ScalarType<"std::json", string>;
...
export declare type $Object_faf27dbcfdb411eca738bf7841d9423dλShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
declare type $Object_faf27dbcfdb411eca738bf7841d9423d = $.ObjectType<"std::Object", $Object_faf27dbcfdb411eca738bf7841d9423dλShape, null>;
export declare type $Object = $Object_faf27dbcfdb411eca738bf7841d9423d
declare const $Object_faf27dbcfdb411eca738bf7841d9423d: $Object_faf27dbcfdb411eca738bf7841d9423d

declare const Object_faf27dbcfdb411eca738bf7841d9423d: $.$expr_PathNode<$.TypeSet<$Object_faf27dbcfdb411eca738bf7841d9423d, $.Cardinality.Many>, null, true> 
...
>;
declare type assert_singleλFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>,
> = $.$expr_Function<
  "std::assert_single",
  _.castMaps.mapLiteralToTypeSet<[P1]>,
...
>;
declare type assert_existsλFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>,
> = $.$expr_Function<
  "std::assert_exists",
  _.castMaps.mapLiteralToTypeSet<[P1]>,
...
>;
declare type assert_distinctλFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>,
> = $.$expr_Function<
  "std::assert_distinct",
  _.castMaps.mapLiteralToTypeSet<[P1]>,
...
> = $.$expr_Function<
  ...
  $.TypeSet<$bool, $.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>>
>;
declare type containsλFuncExpr7<
  P1 extends $.TypeSet<$.ArrayType<_cal.$local_datetimeλICastableTo>>,
...
> = $.$expr_Function<
  ...
  $.TypeSet<$bool, $.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>>
>;
declare type containsλFuncExpr8<
...
> = $.$expr_Function<
  ...
  $.TypeSet<$bool, $.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>>
>;
declare type containsλFuncExpr9<
...
> = $.$expr_Function<
  ...
  $.TypeSet<$bool, $.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>>
>;
declare type containsλFuncExpr10<
...
> = $.$expr_Function<
  ...
  $.TypeSet<$bool, $.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>>
>;
declare type containsλFuncExpr11<
  P1 extends $.TypeSet<$.ArrayType<$.NonArrayType>>,
 ...
 */
declare function bit_not<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
>(
  r: P1,
): bit_notλFuncExpr<P1>;

declare type bit_rshiftλFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  "std::bit_rshift",
...
declare type bit_lshiftλFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  "std::bit_lshift",
...
declare type array_fillλFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.NonArrayType>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  "std::array_fill",
...
> = $.$expr_Function<
  ...
  $.TypeSet<P1["__element__"]["__element__"], $.cardinalityUtil.overrideLowerBound<$.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>, 'Zero'>>
>;
declare type array_getλFuncExpr9<
  NamedArgs extends {
...
> = $.$expr_Function<
  ...
  $.TypeSet<_.syntax.getSharedParentPrimitive<NamedArgs["default"] extends $.TypeSet ? NamedArgs["default"]["__element__"] : undefined, P1["__element__"]["__element__"]>, $.cardinalityUtil.overrideLowerBound<$.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>, $.cardinalityUtil.optionalParamCardinality<NamedArgs["default"]>>, 'Zero'>>
>;
declare type array_getλFuncExpr10<
  P1 extends $.TypeSet<$.ArrayType<$.AnyTupleType>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  "std::array_get",
  ...
  $.TypeSet<P1["__element__"]["__element__"], $.cardinalityUtil.overrideLowerBound<$.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>, 'Zero'>>
>;
declare type array_getλFuncExpr11<
  NamedArgs extends {
...
>;
declare type array_getλFuncExpr12<
  P1 extends $.TypeSet<$.ArrayType<$.NonArrayType>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  "std::array_get",
...
declare type duration_getλFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$duration>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
> = $.$expr_Function<
  "std::duration_get",
  ...
  $.TypeSet<$number, $.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>>
>;
declare type duration_getλFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$date_duration>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
> = $.$expr_Function<
  "std::duration_get",
  ...
  $.TypeSet<$number, $.cardinalityUtil.multiplyCardinalities<$.cardinalityUtil.paramCardinality<P1>, $.cardinalityUtil.paramCardinality<P2>>>
>;
declare type duration_getλFuncExpr3<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$relative_durationλICastableTo>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
> = $.$expr_Function<
  "std::duration_get",
...
>;
declare type duration_truncateλFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$date_duration>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
> = $.$expr_Function<
  "std::duration_truncate",
...
>;
declare type duration_truncateλFuncExpr3<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<_cal.$relative_durationλICastableTo>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
> = $.$expr_Function<
  "std::duration_truncate",
...
declare type str_reverseλFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$str>>,
> = $.$expr_Function<
  "std::str_reverse",
  _.castMaps.mapLiteralToTypeSet<[P1]>,
...
declare type uuid_generate_v4λFuncExpr = $.$expr_Function<
...
declare const range = _.syntax.$range;

declare type range_is_emptyλFuncExpr<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
> = $.$expr_Function<
  "std::range_is_empty",
  [P1],
...
>;
declare function range_is_empty<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
>(
  val: P1,
): range_is_emptyλFuncExpr<P1>;

declare type range_unpackλFuncExpr<
...
>;
declare type range_unpackλFuncExpr2<
...
> = $.$expr_Function<
  ...
  $.TypeSet<$number, $.Cardinality.Many>
>;
declare type range_unpackλFuncExpr3<
  P1 extends $.TypeSet<$.RangeType<_cal.$local_date>>,
> = $.$expr_Function<
  "std::range_unpack",
  [P1],
...
>;
declare type range_unpackλFuncExpr4<
  P1 extends $.TypeSet<$.RangeType<$int32>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  "std::range_unpack",
  ...
  $.TypeSet<$number, $.Cardinality.Many>
>;
declare type range_unpackλFuncExpr5<
  P1 extends $.TypeSet<$.RangeType<$int64>>,
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  "std::range_unpack",
  ...
  $.TypeSet<$number, $.Cardinality.Many>
>;
declare type range_unpackλFuncExpr6<
...
> = $.$expr_Function<
  ...
  $.TypeSet<$number, $.Cardinality.Many>
>;
declare type range_unpackλFuncExpr7<
...
> = $.$expr_Function<
  ...
  $.TypeSet<$number, $.Cardinality.Many>
>;
declare type range_unpackλFuncExpr8<
...
>;
declare type range_unpackλFuncExpr9<
  P1 extends $.TypeSet<$.RangeType<_cal.$local_date>>,
...
> = $.$expr_Function<
  ...
  $.TypeSet<_cal.$local_date, $.Cardinality.Many>
>;
declare type range_unpackλFuncExpr10<
...
>;
declare type range_unpackλFuncExpr11<
...
declare type range_get_upperλFuncExpr<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
> = $.$expr_Function<
  "std::range_get_upper",
  [P1],
...
>;
declare function range_get_upper<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
>(
  r: P1,
): range_get_upperλFuncExpr<P1>;

declare type range_get_lowerλFuncExpr<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
> = $.$expr_Function<
  "std::range_get_lower",
  [P1],
  ...
  $.TypeSet<$.getPrimitiveBaseType<P1["__element__"]["__element__"]>, $.cardinalityUtil.overrideLowerBound<$.cardinalityUtil.paramCardinality<P1>, 'Zero'>>
>;
declare function range_get_lower<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
>(
  r: P1,
): range_get_lowerλFuncExpr<P1>;

declare type range_is_inclusive_upperλFuncExpr<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
> = $.$expr_Function<
  ...
  $.TypeSet<$bool, $.cardinalityUtil.paramCardinality<P1>>
>;
declare function range_is_inclusive_upper<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
>(
  r: P1,
): range_is_inclusive_upperλFuncExpr<P1>;

declare type range_is_inclusive_lowerλFuncExpr<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
> = $.$expr_Function<
  ...
  $.TypeSet<$bool, $.cardinalityUtil.paramCardinality<P1>>
>;
declare function range_is_inclusive_lower<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
>(
  r: P1,
): range_is_inclusive_lowerλFuncExpr<P1>;

declare type overlapsλFuncExpr<
  P1 extends $.TypeSet<$.RangeType<$anypoint>>,
  P2 extends $.TypeSet<$.RangeType<$.getPrimitiveBaseType<P1["__element__"]["__element__"]>>>,
> = $.$expr_Function<
  "std::overlaps",
...
export { bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_faf27dbcfdb411eca738bf7841d9423d, Object_faf27dbcfdb411eca738bf7841d9423d, $FreeObject, FreeObject };
...
declare type __defaultExports = {
  ...
  "Object": typeof Object_faf27dbcfdb411eca738bf7841d9423d;
