...
declare enum $ConnectionTransportλEnum {
  TCP = "TCP",
  HTTP = "HTTP",
}
...
export declare type $JWTλShape = $.typeutil.flatten<$AuthMethodλShape & {
...
declare const JWT: $.$expr_PathNode<$.TypeSet<$JWT, $.Cardinality.Many>, null, true> 
