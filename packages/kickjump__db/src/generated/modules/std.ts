...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "f0b9b0ae-fdb4-11ec-89fd-db66b5086859", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "faeac39c-fdb4-11ec-8c33-d37f6d8c7857", _.syntax.literal);
...
export type $Object_faf27dbcfdb411eca738bf7841d9423dλShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_faf27dbcfdb411eca738bf7841d9423d = $.ObjectType<"std::Object", $Object_faf27dbcfdb411eca738bf7841d9423dλShape, null>;
export type $Object = $Object_faf27dbcfdb411eca738bf7841d9423d
const $Object_faf27dbcfdb411eca738bf7841d9423d = $.makeType<$Object_faf27dbcfdb411eca738bf7841d9423d>(_.spec, "faf27dbc-fdb4-11ec-a738-bf7841d9423d", _.syntax.literal);

const Object_faf27dbcfdb411eca738bf7841d9423d: $.$expr_PathNode<$.TypeSet<$Object_faf27dbcfdb411eca738bf7841d9423d, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_faf27dbcfdb411eca738bf7841d9423d, $.Cardinality.Many), null, true);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "fafc396a-fdb4-11ec-8f76-674063dcc085", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "f0b00e6e-fdb4-11ec-afbe-5f9a05256778", optional: false, setoftype: true, variadic: false}], returnTypeId: "f0b00e6e-fdb4-11ec-afbe-5f9a05256778", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "f0ba965e-fdb4-11ec-969f-f782c8f87797", optional: false, setoftype: true, variadic: false}], returnTypeId: "f0ba965e-fdb4-11ec-969f-f782c8f87797", returnTypemod: "OptionalType", preservesOptionality: true},
...
function contains(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::contains', args, _.spec, [
    ...
    {args: [{typeId: "6c284383-f1ad-99d7-f01c-1e9a96aaca62", optional: false, setoftype: false, variadic: false}, {typeId: "6c284383-f1ad-99d7-f01c-1e9a96aaca62", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
    {args: [{typeId: "6c284383-f1ad-99d7-f01c-1e9a96aaca62", optional: false, setoftype: false, variadic: false}, {typeId: "f0a7928e-fdb4-11ec-ae69-93ade7313e1d", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
...
function range_is_empty(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_is_empty', args, _.spec, [
    {args: [{typeId: "6c284383-f1ad-99d7-f01c-1e9a96aaca62", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function range_get_upper(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_get_upper', args, _.spec, [
    {args: [{typeId: "6c284383-f1ad-99d7-f01c-1e9a96aaca62", optional: false, setoftype: false, variadic: false}], returnTypeId: "f0a7928e-fdb4-11ec-ae69-93ade7313e1d", returnTypemod: "OptionalType"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "fff6c00c-fdb4-11ec-a137-e95bbcf22750", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "fff6c00c-fdb4-11ec-a137-e95bbcf22750", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_faf27dbcfdb411eca738bf7841d9423d,
