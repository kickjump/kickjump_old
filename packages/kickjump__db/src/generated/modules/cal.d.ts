...
export declare type $date_duration = $.ScalarType<"cal::date_duration", unknown>;
declare const date_duration: $.scalarTypeWithConstructor<$date_duration, never>
...
declare type to_date_durationλFuncExpr<
  NamedArgs extends {
    "years"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
    "months"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
    "days"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
 ...
 */
declare function to_date_duration<
  NamedArgs extends {
    "years"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
    "months"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
    "days"?: _.castMaps.orScalarLiteral<$.TypeSet<_std.$number>>,
...
declare type duration_normalize_hoursλFuncExpr<
 ...
 */
declare function duration_normalize_hours<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>,
>(
  dur: P1,
): duration_normalize_hoursλFuncExpr<P1>;

declare type duration_normalize_daysλFuncExpr<
...
>;
declare type duration_normalize_daysλFuncExpr2<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$relative_durationλICastableTo>>,
> = $.$expr_Function<
  "cal::duration_normalize_days",
  _.castMaps.mapLiteralToTypeSet<[P1]>,
 ...
 */
declare function duration_normalize_days<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$date_duration>>,
>(
  dur: P1,
