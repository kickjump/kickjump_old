...
export interface UpdatedType extends CreatedType {
  "updatedAt"?: Date | null;
}
export interface Account extends UpdatedType {
...
export interface Email extends UpdatedType {
  "user": User;
  "primary": boolean;
  "email": string;
  "verified"?: Date | null;
}
export interface User extends UpdatedType {
  "image"?: string | null;
  "name"?: string | null;
  "accounts": Account[];
  "emails": Email[];
